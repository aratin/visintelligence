...
var Providercontracting = keystone.list('Providercontracting');
...
exports = module.exports = function(req, res) {
	...
	// Init locals
		locals.section = 'providercontracting';
		locals.data = [];

	// Load the current Providercontracting
	view.on('init', function(next) {
		var q = Providercontracting.model.find();
		q.exec(function(err, results) {
			locals.data.providercontractings = results;
			next(err);
		});
	});
	...
	// Render the view
	view.render('providercontracting');
}